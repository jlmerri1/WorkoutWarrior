...
public class machineChestFlye extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_machine_chest_flye);
    ...
    private void saveExercise() {
        ...
        finish();
        Intent intent = new Intent(machineChestFlye.this, exercise_list.class);
        startActivity(intent);
    }
    public void backToMuscleGroups(View view)
    {
        Intent intent = new Intent(machineChestFlye.this, MuscleGroup.class);
        startActivity(intent);
    }
    public void backToChest(View view)
    {
        Intent intent = new Intent(machineChestFlye.this, chest.class);
        startActivity(intent);
    }
