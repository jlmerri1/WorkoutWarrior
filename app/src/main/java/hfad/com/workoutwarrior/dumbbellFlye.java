...
public class dumbbellFlye extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dumbbell_flye);
    ...
    private void saveExercise() {
        ...
        finish();
        Intent intent = new Intent(dumbbellFlye.this, exercise_list.class);
        startActivity(intent);
    }
    public void backToMuscleGroups(View view)
    {
        Intent intent = new Intent(dumbbellFlye.this, MuscleGroup.class);
        startActivity(intent);
    }
    public void backToChest(View view)
    {
        Intent intent = new Intent(dumbbellFlye.this, chest.class);
        startActivity(intent);
    }
