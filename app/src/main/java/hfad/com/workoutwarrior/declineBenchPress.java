...
public class declineBenchPress extends AppCompatActivity {
    ...
    private void saveExercise() {
        ...
        finish();
        Intent intent = new Intent(declineBenchPress.this, exercise_list.class);
        startActivity(intent);
    }
    public void backToMuscleGroups(View view)
    {
        Intent intent = new Intent(declineBenchPress.this, MuscleGroup.class);
        startActivity(intent);
    }
    public void backToChest(View view)
    {
        Intent intent = new Intent(declineBenchPress.this, chest.class);
        startActivity(intent);
    }
