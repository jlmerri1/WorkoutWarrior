...
public class barbellBenchPress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_barbell_bench_press);
    ...
    private void saveExercise() {
        ...
        finish();
        Intent intent = new Intent(barbellBenchPress.this, exercise_list.class);
        startActivity(intent);
    }
    public void backToMuscleGroups(View view)
    {
        Intent intent = new Intent(barbellBenchPress.this, MuscleGroup.class);
        startActivity(intent);
    }
    public void backToChest(View view)
    {
        Intent intent = new Intent(barbellBenchPress.this, chest.class);
        startActivity(intent);
    }
