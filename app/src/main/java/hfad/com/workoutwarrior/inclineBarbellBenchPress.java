...
public class inclineBarbellBenchPress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_incline_barbell_bench_press);
    ...
    private void saveExercise() {
        ...
        finish();
        Intent intent = new Intent(inclineBarbellBenchPress.this, exercise_list.class);
        startActivity(intent);
    }
    public void backToMuscleGroups(View view)
    {
        Intent intent = new Intent(inclineBarbellBenchPress.this, MuscleGroup.class);
        startActivity(intent);
    }
    public void backToChest(View view)
    {
        Intent intent = new Intent(inclineBarbellBenchPress.this, chest.class);
        startActivity(intent);
    }
